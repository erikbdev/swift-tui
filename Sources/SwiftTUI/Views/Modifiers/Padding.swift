...
extension View {
  public func padding(_ edges: Edges = .all, _ length: Extended? = nil) -> some View {
    Padding(content: self, edges: edges, length: length)
  }

  public func padding(_ length: Extended) -> some View {
    Padding(content: self, edges: .all, length: length)
  }

  public func padding(_ edges: Edges = .all, _ length: Int) -> some View {
    Padding(content: self, edges: edges, length: .init(length))
  }
}
