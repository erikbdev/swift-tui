...
extension View {
  public func border(_ color: Color? = nil, style: BorderStyle = .default) -> some View {
    Border(content: self, color: color, style: style)
  }

  public func border(_ style: BorderStyle = .default) -> some View {
